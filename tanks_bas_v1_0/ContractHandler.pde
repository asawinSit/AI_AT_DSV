  ...
  */
  float stateMultiplier() {
    switch (owner.tankState) {
      case SEARCH: return 1.0; // Fullt tillgänglig
      case CONTRACTED: return 0.3; // Delvis tillgänglig, kan byta om nytt uppdrag är mycket bättre
      case AIM: return 0.1; // Nästen ej tillgänglig
      case SHOOT: return 0.0; // Ej tillgänglig
      default: return 0.0;
    }
  }
